...
##指令：PUT /users/:loginname/status 激活用户
说明：
	激活用户
输入参数说明：
	无
...
##指令：PUT /users/:loginname/pwd 修改密码
说明：
	修改用户密码
输入参数说明：
	oldpwd：修改前密码（md5）
...
##指令：DELETE /users/:loginname 删除用户
说明：
	【管理员角色】删除一个用户
输入参数说明：
	无                     
